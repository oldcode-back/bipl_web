    ...
    <div className="mb-96">
      <div className="bg-white h-screen ">
        <div className="relative w-full h-[261px]">
          ...
          <div className="absolute top-[-62px] left-1/2 transform -translate-x-1/2 translate-y-1/2 space-y-2 text-center">
            <p className="mb-10 [font-family:'Montserrat-Regular',Helvetica] font-normal text-[#ececec] text-[27px] tracking-[0] leading-[normal]">
